                ...
                if (userClickedOK == true)
                {
                    ...
                    using (Stream myStream = saveFileDialog1.OpenFile())
                    {
                        if (myStream != null)
                        {
                            ...
                            string formattedMessage = string.Format("Save completed. Path: {0} copied to clipboard. Success: {1}", path, true);
                            MainViewModel.Instance.LogStatus(formattedMessage, true);
                            #endregion
                        }
                        else
                        {
